...
\usepackage[paperwidth=6in, paperheight=9in, margin=1in, showcrop]{geometry}
\usepackage{fancyhdr}
...
\usepackage[usefilenames,RM={Scale=0.88},SS={Scale=0.88},SScon={Scale=0.88},TT={Scale=0.88}]{plex-otf}
...
\setmainfont{Times New Roman} % Change this to your main font
...
\newcommand\MoonWalkerOhSix{MoonWalker06}
\newcommand\BarkToThePark{Bark to the Park}
\newcommand\PadfootTwelve{Padfoot12}
...
\parbox{0.80\textwidth}{
			\begin{tcolorbox}[halign=left, colframe=SMSFrom, colback=SMSFrom]
...
\newcommand{\smsToBubble}[1] {	
	\parbox{0.8\textwidth}{
		\begin{tcolorbox}[halign=left, colframe=SMSTo, colback=SMSTo]
			\raggedright\textcolor{onSMSTo}{#1}
		\end{tcolorbox}
	}
	\parbox{0.2\textwidth}{\hfill}
}


\newcommand{\smsConversation}[3]{
	\ifblank{#2}{}{
		\textstyleStrongEmphasis{#2:}
	}
	
	\begin{tcolorbox}[breakable, title=#1, center title,colframe=SMSTitleBack, coltitle=SMSTitleText, colback=white]
		\tupleSwitch{#3}
	\end{tcolorbox}
}
...
\fancyfoot[RO]{\thepage}
\fancyfoot[RE]{Chapter \thechapter}
...
\smsConversation{Unknown Number}{12:40pm}{
...
\smsConversation{Unknown Number}{8:30pm}{
...
\textstyleEmphasis{Sirius,} 

\textstyleEmphasis{I have signed a billion-year contract. I know you won't approve, but I really believe this is the best way for me to do my part to help clear the planet. }

\textstyleEmphasis{This is Barty. He's 2 years old, and his papers and medical records are in a binder in the carrier. I also left some of his favorite toys and enough food for a few days. I told mother I was dropping him off at the shelter, but I just couldn't do that. I feel better knowing he is with you. Please take good care of him for me. }

\textstyleEmphasis{When you are ready to do the right thing, I still have hope that I will see you (and Barty) again.} 

\textstyleEmphasis{Your Brother,\newline R.A.B.} 
...
\centering\includegraphics[width=\textwidth,height=\textheight]{profile}

\chapter{Text Me}

\smsConversation{\BarkToThePark}{4:30PM}{
	\smsFrom, {\BarkToThePark}, {You have a message from Bark to the Park user, \PadfootTwelve.};
	\smsFrom, {\BarkToThePark}, {Type Yes to accept the message};
	\smsTo, {\MoonWalkerOhSix}, {Yes}
}


\smsConversation{\PadfootTwelve}{}{
	\smsFrom, {\PadfootTwelve}, {Hello, \MoonWalkerOhSix. I would like to request your services for an obnoxious miniature pinscher that needs walking. Does 8:00 work for you? Which days are you available?};
	\smsTo, {\MoonWalkerOhSix}, {Hi, that's great, I'm sure they are nothing I can't handle. \emoji{winking-face} Right now I am available every evening except for Wednesdays and Fridays.};
	\smsFrom, {\PadfootTwelve}, {Okay cool, let's book an hour on all of those nights. Do you know where Godric's Hollow is?};
	\smsTo, {\MoonWalkerOhSix}, {Yup, no problem! So, five nights a week? The app has my rates, just want to make sure that is okay with you.};
	\smsFrom, {\PadfootTwelve}, {Of course, but I do have one very important question before we proceed.};
	\smsFrom, {\PadfootTwelve}, {Can you really moonwalk?};
	\smsTo, {\MoonWalkerOhSix}, {Oh, haha, the username. I just thought it was a clever way to indicate I am only available for night time walks.};
	\smsFrom, {\PadfootTwelve}, {That doesn't really answer the question, Moonboy \emoji{winking-face-with-tongue}};
	\smsTo, {\MoonWalkerOhSix}, {Well, yes, I can moonwalk. I mean, it's not that hard. Can't everyone?};
	\smsTo, {\MoonWalkerOhSix}, {I look forward to meeting Padfoot (I assume that's your dog's name?) Did you want to start tonight?};
	\smsFrom, {\PadfootTwelve}, {Ah, haha no the dog is called Barty. I'm Padfoot.};
	\smsFrom, {\PadfootTwelve}, {I mean yes. About starting tonight. Barty looks forward to meeting you, too. \emoji{smiling-face-with-smiling-eyes}};
	\smsTo, {\MoonWalkerOhSix}, {Barty, that's an interesting name for a dog. Short for Bartholemew?};
	\smsTo, {\MoonWalkerOhSix}, {Padfoot is an interesting name for a human.};
	\smsFrom, {\PadfootTwelve}, {It's short for Bartemius actually. It's a stupid name for a dog. My weird brother named him.};
	\smsFrom, {\PadfootTwelve}, {Padfoot is a perfectly normal name for a human, Moony. (*\string^\symbol{"203F}\string^*)}
}

\smsConversation{\Padfoot}{8:00PM}{
	...
	\smsTo, {\Moony}, {\centering\includegraphics[width=\textwidth]{taylor-heery-tOsfvWC_fFo-unsplash (1)}};
...
\smsConversation{\Padfoot}{8:10PM}{
...
\centering\includegraphics[width=\textwidth]{iPhone 13 Pro Max - 3}

\smsConversation{\Padfoot}{8:50PM}{
...
``Oh yeah, it's a good review. He's also uploaded a profile picture. Lily, you have to see this.'' He passed the phone back to her.
 ...
 \centering\includegraphics[width=\textwidth, height=\textheight]{photo overlay}
...
Padfoot\newline
\textbf{Moony:}Wow, Padfoot, I don't know what to say. Thank you for the glowing review. I'm already getting more jobs lined up.\newline
\textbf{Padfoot:}You deserve it, Moony. Barty was raving about you.\newline
\textbf{Moony:}Barty is actually a really well behaved dog. He's definitely been trained. You said he isn't yours?\newline
\textbf{Padfoot:}No, he's my brother's. I'm not really a dog person. At least not small dogs. I prefer them big, fluffy, and with lots of drool. Honestly, I think I was just traumatized as a child by a horrible hairless chihuahua of my mother's.\newline
\textbf{Moony:}LOL Okay, it all makes sense now. I love all sorts of dogs, but even I find hairless chihuahuas disturbing. \emoji{grimacing-face}\newline
\textbf{Padfoot:}He was a creepy little gremlin named Kreacher. He hated me, growled and snapped at me whenever I came near. I have no idea why. I'm obviously delightful! He loved my mother and my brother though, would follow them around and act all innocent for them. Little bitch.\newline
\textbf{Padfoot:}I imagine Kreacher has ``crossed the rainbow bridge'' by now. Mother probably had him stuffed and mounted on the mantelpiece, knowing her. *shudders*.\newline
\textbf{Moony:}\emoji{face-screaming-in-fear} Thanks for the mental image to haunt my nightmares, Padfoot.\newline
\textbf{Moony:}Got to go, duty calls.\newline
\textbf{Padfoot:}\emoji{pile-of-poo} Over the next week, messages from Padfoot were few and far between. Remus started to think maybe he had imagined the connection he felt in their easy banter of the first couple of interactions. Still, he couldn't help the queasy nervous excitement he felt when he went to Godric's Hollow each night, hoping that Mr.\ Black himself would come out to greet him with Barty. It was silly, but he found himself taking more time grooming himself, even putting on cologne, and choosing his most whimsical socks to wear. He imagined Padfoot would tease him about them if he saw them. It was a pathetic little fantasy, he realized. And every night, he felt the sting of disappointment when it was Shackelbolt who greeted him at the gate, with Barty leashed up and ready for his walk.
...
\textbf{Padfoot:}OMG MOONY YOU MAD GENIUS

\textbf{Moony:}I have no idea what you are referring to, Padfoot.\newline
\textbf{Padfoot:} \includegraphics{poopmap}
\newline
\textbf{Moony:}Oh right, yeah I meant to ask… What have you been feeding this dog??\newline
\textbf{Padfoot:}I told Prongs vegan pet food was a bad idea! He's clearly crying out for help.\newline
\textbf{Padfoot:}I'm so sorry you have had to deal with all this shit, Moony. You are an angel\emoji{baby-angel}\newline
\textbf{Moony:}I am going through poop bags at an alarming rate. I assume I can just submit an expense report for reimbursement? \emoji{money-with-wings}\newline
\textbf{Padfoot:} \includegraphics{Screenshot_20220615-103936}
\newline
\textbf{Padfoot:}Don't you even worry about that, I'll make sure you are fully stocked. 
...
Moony
\textbf{Moony:}Padfoot, I'm so sorry, but I have to cancel my walk with Barty tonight. Something came up. I'm really sorry.\newline
\textbf{Padfoot:}You don't need to apologize. Do what you need to do. I hope it's nothing bad?
...
Moony
\textbf{Moony:}Well, it isn't good.\newline
\textbf{Moony:}It's my mom. She isn't well. Hasn't been for a long time, but it's taken a turn for the worse and I just really need to be there with them.\newline
\textbf{Padfoot:}Of course. I'm so sorry to hear that. I know what that's like. Go and be with your parents, Moony. I wish there was something I could do to help.\newline
\textbf{Moony:}Well, I have a 40 minute bus ride to imagine every horrible outcome. I could use a distraction… Have any funny stories?\newline
\textbf{Padfoot:}Yeah, okay, funny stories, I can do that! Just give me a minute.\newline
\textbf{Padfoot:}So, when I was a teenager, my parents sent me to a boarding school in L.A. A ``performing arts'' school. A real fancy one, where the celebrities send their kids.\newline
\textbf{Padfoot:}My best friend really wasn't interested in performing arts at all. I think his parents just sent him there because some of their friends told them it was a good school. But he and I were easily bored and usually looking for ways to cause trouble.\newline
\textbf{Padfoot:}We had this horrible class on Etiquette. Our teacher was a real piece of work. I swear she actually hated teenagers with a passion. She would dole out punishments for the slightest thing. If a girl in the class would giggle, or if a boy showed up with his shirt untucked, she would tut about how ``inappropriate'' it was and assign detention. Oh and she had this high pitched voice and spoke in a fake posh british accent, it made my skin crawl.\newline
\textbf{Padfoot:}She would wear these big pink bows in her hair, and I swear to god Moony, she looked like a toad. I'm not being cruel, facts are just facts.\newline 
\textbf{Padfoot:}One day we were going to have a lesson on table manners, so they had set up a table like some English tea party. They had put out trays of sandwiches and tea cakes. You know the serving trays with the silver covers over them like they have at hotels.\newline
\textbf{Padfoot:}It had been rainy and muddy out, so my friends James and Peter and I brought a shoebox outside and started digging up worms and filling the box with them.\newline
\textbf{Moony:}Oh I think I see where this is going \emoji{frog}\emoji{worm}\newline
\textbf{Padfoot:}Shh \emoji{shushing-face} patience moony, I'm telling a story here\newline
\textbf{Padfoot:}We snuck into the classroom early and started putting handfuls of worms under the serving lids. We must have miscalculated how much time we had, because the bell rang and people started coming into the classroom. So, we jumped into our seats and started frantically wiping our hands on the table cloth under the table. That's when I noticed the panicked look on Peter's face.\newline
\textbf{Padfoot:}Well, Umbridge (that's toad face) noticed his squirming too, and was joyfully assigning him detention when she opened the lid of one of the serving trays. She started shrieking, and other kids were lifting their serving lids and more girls started shrieking, and before you knew it, the classroom was filled with glorious pandemonium.
\textbf{Padfoot:}Prongs (that's James) and I were literally rolling on the floor laughing. Especially when Pete finally stood up and we saw why he was squirming. He had sat directly on the box of worms. When he got up, his ass was covered in squished and squirmy worms and he was mortified!\newline
\textbf{Padfoot:}And that's how Peter got his nickname, Wormtail. He would never live that one down.\newline
\textbf{Moony:}\emoji{face-with-tears-of-joy} Brilliant. I'm sure you all learned your lesson in detention?\newline
\textbf{Padfoot:}Fat chance. We did the same thing a week later, but even better, we used actual toads. Harder to procure, but worth it for the payoff.\newline
\textbf{Moony:}\emoji{rolling-on-the-floor-laughing}\emoji{rolling-on-the-floor-laughing} That's amazing. You were naughty, weren't you? So if that's how Wormtail got his nickname, what about Prongs?\newline
\textbf{Padfoot:}Ah, well it's not as funny of a story, but it's from the same class. We had to learn to tell forks apart by the number of tines. That was the word we used, but James kept using the word ``prongs'', like ``Which one has only 3 prongs?'' And I would laugh at him and tell him ``They aren't ‘prongs', idiot, their ‘tines''' and he would tell me
...
\textbf{Moony:}I'm at the hospital now. Thank you for the story, and the distraction, Padfoot. I mean it. It really helped. \emoji{smiling-face-with-smiling-eyes}\newline
\textbf{Padfoot:}Any time, Moony.
...
Padfoot\newline
\textbf{Padfoot:}I decided to walk Barty myself tonight. I tried to follow your usual path from the map on the app, and he seemed okay with it but I think he was disappointed by the lack of moonwalking.\newline
\textbf{Padfoot:} \includegraphics{dog-gdb55341e4_640}
\newline
\textbf{Padfoot:}See? All tuckered out.\newline
\textbf{Padfoot:}I hope your mom is okay. I hope you are okay.\newline
\textbf{Moony:}thank you, you're sweet. I'm okay, really. My dad told me to go to his apartment and get some rest. I don't feel very restful though.\newline
\textbf{Padfoot:}Want to talk?\newline
\textbf{Moony:}Yeah, I'd like that.

\textstyleStrongEmphasis{**Incoming call from Padfoot**} 

\textstyleEmphasis{Oh god.} Remus thought, \textstyleEmphasis{he meant ‘talk' talk, like voice talk.} Somehow, that felt so much more intimate than texting. Remus could feel his heart pounding in his chest as he swiped up, answering the call. ``Hi, Padfoot.''
...
\textstyleEmphasis{A billion years? What an odd thing to say}, Remus thought. But he decided it would be best to let that one go and humor him, ``I would love to hear how you got your nickname, Padfoot.''
...
Emmeline (Emma)\newline
\textbf{Emma:}Sirius, babe! I have exciting news!!! What are you doing this September?\newline
\textbf{Emma:}I'll tell you what you are doing, you are going to New York Fashion Week!\newline
\textbf{Sirius:}Hey Em {\textless}3\newline
\textbf{Sirius:}LOL that's the dream, right.\newline
\textbf{Emma:}Sirius, you're not listening babe --- You are going to come to Fashion Week! Here's the deal, I was at an event with The Weird Sisters and I ran into none other than Madam Malkin herself. We got to talking and babe, you would be the perfect model for her new men's suit line, which I told her. I showed her a few pictures and she agreed. She wants you! You need to send a portfolio ASAP, I'll email ya with the details. But babe, you are a shoe-in!\newline
\textbf{Sirius:}Omigod Em, that's incredible! Thank you so much!\newline
\textbf{Emma:}You deserve it, babe, this is going to be huge for you! Oh but fair warning there may be one small hurdle…\newline
\textbf{Emma:}One of the producers of the show is Lucius Malfoy.\newline
\textbf{Sirius:}Oh, fuck. Well, it was a nice dream. There's no way he'll let her hire me, I'm a dangerous suppressive. \emoji{sad-but-relieved-face}\newline
\textbf{Emma:}Malkin is on your side though, she thinks the Scientologists are wackos so she's willing to fight for you. But your portfolio needs to blow the rest of the board away. And it will, you are seriously perfect for this job, hon. Screw Malfoy, you got this!!! \emoji{thumbs-up}\emoji{raising-hands}\emoji{flexed-biceps}\emoji{hugs}\newline
\textbf{Sirius:}Thanks for the heads up, and Em thanks for everything really. If this works out I owe you big!

Marlene\newline
\textbf{Sirius:}Marls, what are you doing tonight?\newline
\textbf{Marlene:}No plans, did you want to hit up the Hogs Head again?
\emoji{winking-face-with-tongue}\emoji{tropical-drink}\emoji{clinking-beer-mugs}\newline
\textbf{Sirius:}LOL I'm still recovering from last time!\newline
\textbf{Sirius:}Actually, I need some help putting together a portfolio for Madame Malkin to apply for NY fashion week. Emma says she wants me, just need to impress the board enough and I'm in\newline
\textbf{Marlene:}Shit, Sirius, that's huge! Of course I'll help you. Meet at the studio in an hour?\newline
\textbf{Sirius:}Hell yeah, on my way!
...
\textstyleStrongEmphasis{***calling Padfoot***} 
...
Prongs\newline
\textbf{Prongs:}I dropped Remus off at the pet hospital.\newline
\textbf{Prongs:}Sirius, he's so sweet. You need to make him our friend.\newline
\textbf{Sirius:}I'm way ahead of you, already invited him over. I just need to fill out a couple of forms then I'm bringing him to the house to clean up his cuts and have a beer.\newline
\textbf{Prongs:}Oh good, I'll find a clean t-shirt and some gym shorts for him so he can get out of those bloody clothes.\newline
\textbf{Prongs:}Think Remus likes IPA? NVM I'll just bring up a variety from the basement fridge. See ya soon!!
\emoji{clinking-beer-mugs}\newline
\textbf{Sirius:}Anything is fine, thanks Prongs!
...
``What? It's true! You were like \textstyleEmphasis{{}`Oh, he's cute, I want this one!'}'' James was really laughing now, and retaliating by flicking more bottle caps back at Sirius. Remus covered his head with his arms, hiding his own reddening face while trying to stay out of the line of fire as the battle continued.
...
Moony\newline
\textbf{Padfoot:}Good Morning, Moony!\newline
\textbf{Moony:}Padfoot, it's 12:30. It's literally the afternoon now.\newline
\textbf{Padfoot:}Good Afternoon, Moony! How was your morning, then?\newline
\textbf{Moony:}Good Afternoon, Padfoot. My morning was rough. It took a lot of espresso to get me through my early class. Feel pretty good now, though. Any news about Barty?\newline
\textbf{Padfoot:}I'm about to go pick him up. They said he is in good shape, but no moonwalking for a couple of days.
\emoji{crying-face}\newline
\textbf{Padfoot:}Are you walking Hokey and Pokey tonight?\newline
\textbf{Moony:}If she hasn't fired me, then yes, that's the plan\newline
\textbf{Padfoot:}James wants me to ask you to come over after you drop off the poodles because he already misses you, the soppy idiot.\newline
\textbf{Moony:}Awww, tell James I miss him too. \emoji{smiling-face-with-heart-eyes} I'd love to come and visit him.\newline
\textbf{Padfoot:}I hate you both.\newline
\textbf{Moony:}It's a good thing I'm so cute then \emoji{winking-face}\newline
\textbf{Padfoot:}Oh my god.\newline
\textbf{Moony:}See you tonight, Padfoot.\newline
\textbf{Padfoot:}Yeah, see you then Moony.
...
``Well, they're not supposed to, really.'' Sirius sighed, ``But you're probably right, Moony. I think Regulus does love Barty. And \textstyleEmphasis{okay}, maybe he sort of cares about me, too.''

Remus put a hand on Sirius's arm, squeezing it ever so gently. ``Of course he does.\ \textstyleEmphasis{I} care about you, and I've only just met you.'' And Sirius really, really wanted to kiss him. And just when he thought he might have the courage to do it, and started leaning forward ---
...
\textstyleStrongEmphasis{Regulus} 
...
\textbf{Alice:}Lils, I'm so sorry, I'm stuck late at work. We got a parent going back into rehab and need to get the kids relocated. It suuuucks!

\textbf{Lily:}Oh no! I understand, sweetie. Do what you need to do, but let's please reschedule! I miss you!!

\textbf{Alice:}Miss you too, hon! Keep sending dress pictures! I'm keeping a Google file of my favorites and we'll go through them together! I'm gonna be the hottest bride in SoCal this fall!
...
Alice\newline
\textbf{Lily:}Oh Alice, you would be gorgeous in this one!\newline
\textbf{Lily:} \includegraphics{jonathan-borba--shn8ecaH2w-unsplash}
\newline
\textbf{Alice:}Yes!! **saving** 
...
\textbf{Lily:}Yes. I know, it's about time. \emoji{weary-face}\newline
...
\textbf{Remus:}Yeah, I get that. James Potter is a ray of sunshine \emoji{sun-with-face}\newline
\textbf{Lily:}\emoji{face-with-tears-of-joy} He feels the same about you, Remus. That boy raves about you!\newline
...
\textbf{Lily:}This morning?? Remus! So I take it you and Sirius made up, then? \emoji{winking-face}\newline
...
\textbf{Lily:}Oh, Remus \emoji{worried-face} I'm so sorry.\newline
...
\textbf{Remus:}And good luck with your date! \emoji{kissing-face}
...
\textstyleEmphasis{normal}. It was probably what he liked about him so much. 
...
``Do you want me to stay?'' If he stayed would it be obtrusive? Would it be overbearing? Obsessive? Or was it a nice thing to do? To provide support? To offer a ride when Remus was ready? He wanted to stay.\ \textstyleEmphasis{Please, please want me to stay. }
...
Sirius told himself, \textstyleEmphasis{this is what Moony needs}. But deep down he knew, it was the opposite of what Remus needed. But it was what he, Sirius, wanted. And Sirius was so, so selfish.
...
\textstyleEmphasis{Oh god, not this again.} Sirius had admitted before that his upbringing had trained him that when something bad happens it is because of something he did that the church considers ``low-toned''. And having a sexual relationship with another man was about as low-toned as it got. And so Sirius had to be constantly reminded that things weren't his fault. Even thinking it was his fault wasn't his fault. And Remus knew that. But \textstyleEmphasis{boy was it exhausting.}
...
Remus lowered his sunglasses to give Sirius a very pointed glare that said, \textstyleEmphasis{Are you fucking kidding me?} Sirius deflated. Remus was good at games, and almost always won anything they played. But he looked upon contact sports with derision, and apparently Chicken was too much of a contact sport. ``Oh don't pout, Padfoot. Why don't you ask Mary to play with you?'' Remus suggested, brushing him off and returning to the important business of soaking up the sun.
...
As Remus smoothed the cool cream over his back and shoulders, Sirius looked over at the tiki bar again, where Gideon was dancing and singing along to a Bob Marley song while he poured drinks into plastic cups. ``What if I asked Gid to be my partner?'' Maybe Remus just didn't get jealous of Mary because she was a girl. But Gideon was a handsome man. That ought to bother his boyfriend at least a little.\ \textstyleEmphasis{Right?}
...
\textbf{Remus:}Lily told you \emoji{person-facepalming}\newline
\textbf{James:}You can't be angry with her, she is powerless against my charms. \emoji{beaming-face-with-smiling-eyes}\newline
...
\textbf{James:}So, what do you say, Moony. Will you move in with me? \emoji{pleading-face}\emoji{folded-hands}[D83C?][DFFD?]\newline
\textbf{Remus:}Well, how can I say no to that?\newline
\textbf{Remus:}I will accept your generous offer, James, because I'd rather not be homeless, and also I would love to live with you. \emoji{growing-heart}\newline
...
\textbf{Remus:}Like I took care of Padfoot last night? \emoji{winking-face-with-tongue}\newline
\textbf{James:}Oh God stop, I don't want to know. \emoji{face-vomiting} I rescind my offer.\newline
\textbf{Remus:}Too late! It's a done deal, Prongs. Now you have to live with your decisions.\newline
\textbf{James:}\emoji{grinning-face-with-smiling-eyes}
...
\textbf{Moony:}Knew you would understand \emoji{face-blowing-a-kiss}
...
Padfoot\newline
\textbf{Padfoot:} \includegraphics{ivan-mani-bRv5vZcbAa4-unsplash}
\newline
\textbf{Padfoot:}We made it. New York, New York\newline
\textbf{Moony:}Miss you already! \emoji{face-blowing-a-kiss}

\textstyleStrongEmphasis{(Two days later)} 

Padfoot\newline
\textbf{Padfoot:}Mary's lunch. I hate her.  \includegraphics{peter-bravo-de-los-rios-OklpRh8-Sns-unsplash}
\newline
\textbf{Padfoot:}My lunch. This diet sucks.  \includegraphics{kelly-visel-zXn-amUiMJ4-unsplash}
 

\textstyleStrongEmphasis{(A couple of hours later)} 

Padfoot\newline
\textbf{Padfoot:}I'm a proper tourist now.  \includegraphics{xiaochuan-xu-0fMSLUYClVI-unsplash}
 

\textstyleStrongEmphasis{(many hours later)} 
...
Sirius was in shock. He thought he must be having a mental breakdown. Hallucinating. There was no way this was really happening. ``\textstyleEmphasis{Narcissa} is helping you?'' 
...
``Padfoot, no. God, I was afraid \textstyleEmphasis{you} wouldn't want to speak to \textstyleEmphasis{me} again.'' He paused, rubbing circles over Sirius's hand with his thumb. ``So, um, James gave me a little more context about maybe why you said what you did. You never told me… I didn't know. I'm sorry.''
...
\textstyleEmphasis{None of this is about the truth. It never was.} 

And if auditing is not about finding the truth, then maybe nothing the church has ever told him was true. 

\textstyleEmphasis{Sirius was right all along.} It was all so clear now. Everything they did was about power. It was about control. It was about money. They weren't clearing the planet at all. 
...
\textstyleEmphasis{You will be glad to know that I am ready to do the right thing --- Getting you the fuck out of there. I hope that you are ready as well. If that is the case then you will see me (and Barty) very soon. }

\textstyleEmphasis{There is a costume in the bag. Put it on and follow Velma to The Mystery Machine. I will be waiting for you there.} 
...
\textstyleEmphasis{after} freeing Regulus from Gold Base. ``Well, obviously we'll need to get you some clothes and stuff. I think some of mine will fit you for now…''
...
Remus raised an eyebrow, questioning, and she shook her head clearly communicating \textstyleEmphasis{not now}. He got the message, grabbing one beer and one bottle of water from the fridge and following her up the stairs to the living room.
...
``Well, of course, but I get \textstyleEmphasis{physical affection} from Moony. So maybe Reggie needs a girlfriend?'' 
...
\textstyleEmphasis{\textstyleStrongEmphasis{19 Months Later} }
...
\textstyleEmphasis{Blowing Clear: Escape from Scientology}) for that purpose. With the help of the social media marketing knowledge of Marlene, Xenophilius, and Sirius, the channel was a huge success. And now Regulus and Pandora were being invited to interviews on local news stations, too. He finally felt like he was really making a difference. The attacks he received from the church were barely a nuisance any more. He felt powerful, and the church was just a pitiful annoying fly that he could swat away with the wave of his hand.
...
\textbf{Sirius:} \includegraphics{denimjacket}
 The jacket is in my closet. It will look \emoji{fire} on you.\newline
\textbf{Regulus:}I don't know if that's really my style.\newline
\textbf{Sirius:}Of course not. It's my style. You're welcome! \emoji{winking-face} Good luck, Reg! Send us the clip after it airs!\newline
...
Lily\newline
\textbf{Remus:} \includegraphics{the-travel-nook-2FoqQ0EPwLg-unsplash}
  Greetings from Jamaica! Wish you were here!\newline
\textbf{Lily:}Oh wow, definitely jealous. But you do not wish I was there! I know you are enjoying your alone time with your \textstyleEmphasis{husband!} \emoji{man}\emoji{red-heart}\emoji{man}\newline
\textbf{Remus:}Yes, I am enjoying my husband. I will never get tired of saying that.\newline
\textbf{Remus:}My husband. Do you ever get used to that? \emoji{face-with-tears-of-joy}\newline
\textbf{Lily:}I don't know, I've been married for a year and a half and I'm still not used to it.\newline
\textbf{Lily:}I'm so happy for us all. \emoji{smiling-face-with-heart-eyes} Send Sirius my love.\newline
...
``Remus Lupin-\textstyleEmphasis{Black}'' Remus corrected him, leaning over to kiss him. It was intended to be a quick kiss before heading to the bar, but Sirius put a hand on his neck pulling him in closer, and Remus was starting to forget what he was supposed to be doing. ``Hmm, should we head back to our suite before you get a sunburn? I mean, I'm really only thinking about your health here.'' 

``Mm, not a bad idea, husband dearest. But I still want my milkshake.'' Sirius stood, taking Remus by the hand to head to the bar together. And as they sipped their dirty bananas and walked hand-in-hand through paradise back to their room, he thought, \textstyleEmphasis{so this is what happily ever after feels like}. 

\textstyleStrongEmphasis{The End} \chapter{Afterword}
