...
\title{\textbf{\fontspec{Quantico}Engrams }\small\textbf{\fontspec{Open Sans} and } \huge\textbf{\fontspec{Moon Dance} Moonwalks}}
...
\newcommand{\smsPic}[2]{
	\hspace*{0.25\textwidth}\includegraphics[width=0.5\textwidth, alt=#2]{#1}
}
...
\smsConversation{Padfoot12}{
	...
	\smsFrom, {Padfoot12}, {Padfoot is a perfectly normal name for a human, Moony. (*\string^{\fontspec{Times New Roman}\symbol{"203F}}\string^*)}
}
...
\includegraphics[width=\textwidth]{iPhone 13 Pro Max - 3}\vspace{3em}
...
{\includegraphics[width=\textwidth]{photo overlay}}
...
\smsConversation{Moony}{
	...
	\smsFrom, {Padfoot}, {\smsPic{poopmap}{}};
	...
	\smsFrom, {Padfoot}, {\smsPic{Screenshot\_20220615-103936}{}};
...
\begin{center}
{
	\abnormalparskip{0em}\fancyqr[image=\includegraphics{AmethystHeart2421}, image padding=-.10, height=2.7in, r color=DarkPurple, l color=LightPurple, tight, version=7 ]{https://archiveofourown.org/works/39624996/comments/new}
}
\end{center}
