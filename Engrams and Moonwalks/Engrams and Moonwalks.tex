...
\setmainfont{Roboto} % Change this to your main font
...
\newcommand\Emma{Emmeline (Emma)}
\newcommand\Sirius{Sirius}
\newcommand\Marlene{Marlene}
...
\newcommand{\smsConversation}[2]{
	\begin{tcolorbox}[breakable, title=#1, center title,colframe=SMSTitleBack, coltitle=SMSTitleText, colback=white, fonttitle=\bfseries]
		\tupleSwitch{#2}
	\end{tcolorbox}
	\vspace{2em}
}
...
\chapter{Text Me}
\textbf{4:30PM}\vspace{-3em}
\smsConversation{\BarkToThePark}{
...
\smsConversation{\PadfootTwelve}{
	...
	\smsFrom, {\PadfootTwelve}, {Padfoot is a perfectly normal name for a human, Moony. (*\string^{\fontspec{Times New Roman}\symbol{"203F}}\string^*)}
}
\textbf{8:00PM}\vspace{-3em}
...
{\centering\includegraphics[width=\textwidth]{iPhone 13 Pro Max - 3}\vspace{3em}}

\textbf{8:50PM}\vspace{-3em}
\smsConversation{\Padfoot}{
...
\smsConversation{\Moony}{
	...
	\smsFrom, {\Padfoot}, {I'm so sorry you have had to deal with all this shit, Moony. You are an angel\emoji{baby-angel}};
	\smsTo, {\Moony}, {I am going through poop bags at an alarming rate. I assume I can just submit an expense report for reimbursement? \emoji{money-with-wings}};
...
\smsConversation{\Padfoot}{
	...
	\smsFrom, {\Padfoot}, { {\centering\includegraphics[width=\textwidth]{dog-gdb55341e4_640}}
	};
...
\smsFrom, {Alice}, {Miss you too, hon! Keep sending dress pictures! I'm keeping a Google file of my favorites and we'll go through them together! I'm gonna be the hottest bride in SoCal this fall![D83D?][DC70?][D83C?][DFFC?][D83D?][DC92?][D83D?][DC90?]}
}
...
\smsTo, {Lily}, { {\centering\includegraphics[width=\textwidth]{jonathan-borba--shn8ecaH2w-unsplash}}
};
...
\textbf{Lily:}Oh wow, definitely jealous. But you do not wish I was there! I know you are enjoying your alone time with your \textit{husband!} \emoji{man}\emoji{red-heart}\emoji{man}\newline
